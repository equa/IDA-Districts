...
(EQUATION-FRAME :AT ((75 262)) :R (19 19) :ICON "lib:gain.ids" :SLOT ("vel") :NAME "vel" :DATA MODEL :D "Output the element-wise product of a gain vector with the input signal vector") 
...
(CONNECTION-LINE :AT ((1882/5 46) (1934/5 46)) :FIRST-LINK ("TDuct-Const" (1 0.5) LINK) :LAST-LINK ("TDuct" (0 0.491) (INSIGNALLINK 1)) :DIR :RIGHT :ARROW (19 8 8)) 
(EQUATION-FRAME :AT ((349 46)) :R (18.2 10) :ICON "sys:constant.ids" :SLOT ("TDuct-Const") :NAME "TDuct-Const" :DATA SOURCE-CONSTANT) 
