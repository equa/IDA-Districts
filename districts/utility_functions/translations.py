...
def _register_translation_keys():
    ...
    tr("drilling_depth")
    tr("drilling_radius")
    tr("borehole_heat_resistance")
    tr("heat_resistance_between_pipe_innergrout")
    tr("heat_resistance_between_pipe_earth")
    tr("heat_resistance_between_innergrout_outergrout")
    tr("heat_resistance_between_grout_earth")
    tr("heat_resistance_between_grouting_earth")
    tr("heat_capacity_ground")
    tr("heat_transfer_coefficient_ground")
    tr("density_ground")
    tr("heat_capacity_grout")
    tr("heat_transfer_coefficient_grout")
    tr("density_grout")
    tr("radius_pipe")
    tr("thickness_pipe_wall")
    tr("heat_capacity_pipe_wall")
    tr("heat_transfer_coefficient_pipe")
    tr("liquid_type")
    tr("liquid_freezing_point")
    tr("heat_transfer_coefficient_liquid")
    tr("length_surface_casting")
    tr("heat_transfer_coefficient_surface")
    tr("density_surface")
    tr("heat_capacity_surface")
    tr("mir")
    tr("distance_borehole_boundary")
    tr("no_earthrings")
    tr("no_borehole_nodes")
    tr("total_no_nodes_z")
    tr("no_points_direction1")
    tr("no_points_direction2")
    tr("no_points_direction3")
    tr("timestep_outputs")
    tr("yearly_mean_temp")
    tr("temp_gradient_ground")
